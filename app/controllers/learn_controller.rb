class LearnController < ApplicationController
  ...
  def lesson1
    ...
    data = "USER=email%40example.com&PASSWORD=g1VPD20qBH3qHmzJ&AMOUNT=25&CURRENCY=USD&RECEIVEREMAIL=recipient%40example.com&SENDEREMAIL=myemail%40example.com&PURCHASETYPE=1&NOTE=This+is+a+test+transaction.&TESTMODE=1"
